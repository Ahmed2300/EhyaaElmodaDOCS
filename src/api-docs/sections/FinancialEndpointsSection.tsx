  ...
  return (
    <section id="financial-endpoints" className="docs-section">
      ...
      <Alert type="warning" icon="shield">
        ...
        <br />
        4. <strong>الخصم الفوري واللحظي للعهدة:</strong> يُعاد احتساب الرصيد الحالي لعهدة المندوب (<code>financial_imprest</code>) **مع إتمام كل زيارة/أوردر فردي ناجح فوراً** (عند الـ Check-out وتوريد الوزن)، حيث يُخصم ثمن الملابس المشتراة لحظياً في قاعدة البيانات ولا يتم الانتظار حتى نهاية يوم العمل لتسوية العهدة بالكامل.
      </Alert>
