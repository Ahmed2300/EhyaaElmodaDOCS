...
if ($distance > 500) {
    throw ValidationException::withMessages([
      ...
      <Alert type="success" icon="check_circle">
        ...
        <br />
        4. <strong>خصم فوري للعهدة:</strong> يتم احتساب التكلفة الكلية (الوزن × السعر) وخصمها فوراً ولحظياً من رصيد عهدة المندوب الجارية (في جدول المستخدمين وعبر السجل العام) بدلاً من الانتظار لنهاية اليوم.
      </Alert>
