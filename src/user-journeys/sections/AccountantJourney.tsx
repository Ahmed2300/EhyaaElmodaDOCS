...
const AccountantJourney: React.FC = () => {
  ...
  return (
    <section id="accountant" className="docs-section">
      ...
      <JourneyStep number={3} title="تسوية ومطابقة حسابات المحفظة دفترياً" icon="balance" color={roleColor}>
        <p>بعد اعتماد الفواتير، يقوم المحاسب بتسوية ومطابقة حسابات محفظة المندوبين دفترياً:</p>
        <div className="journey-resolution" style={{ background: '#fef7e0' }}>
          ...
          <div>
            <strong>التسوية والمطابقة:</strong> يراجع المحاسب العمليات المالية لكل مندوب للتأكد من مطابقة مبالغ المشتريات والمصروفات المخصومة من محفظتهم الجارية مع الأوزان المسلمة بالمخزن. يظل الرصيد المتبقي في المحفظة مستمراً للشفت القادم، ويمكن للأدمن/المحاسب شحنها إضافياً عند الحاجة.
          </div>
        </div>
      </JourneyStep>
